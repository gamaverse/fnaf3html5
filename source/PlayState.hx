		...
		switch (curStage)
		{
			...
			case 'stageverlasting':
								...
								for (stage in stagesAnimated)
								{
									...
									if ((stage.name == 'bflighter'))
									{
										if (/*immersionLevel == 'Partial'*/1==0)
										{
			...
			case 'stagephantom':
								...
								{
									/*
									if ((ClientPrefs.lowQuality || epilepsy && stage.name == 'phantoms'))
									{
										precacheImage(stage.image);
								...
								{
									precacheImage(jumpscare.image);
									if ((jumpscare.name == 'phfreddyjump' || jumpscare.name == 'foxyjump' || jumpscare.name == 'chicajump' || jumpscare.name == 'manglejump'/* && !epilepsy*/))
									{
										makeAnimatedLuaSprite(jumpscare.name, jumpscare.image, jumpscare.posX, jumpscare.posY);
								...
								//setObjectOrder('dadGroup', getObjectOrder('freddy2'));
								trace('freddy2 order: ' + getObjectOrder('freddy2'));
			...
			case 'stageretribution':
								...
								setObjectCamera('aftonwear', 'hud');
								addLuaSprite('aftonwear', false);
								...
								for (miscSprite in miscSprites)
								{
									...
									setScrollFactor(miscSprite.name, miscSprite.scrollX, miscSprite.scrollY);
									scaleObject(miscSprite.name, miscSprite.scaleX, miscSprite.scaleX);
									if ((miscSprite.camera != 'camGame' && /*immersionLevel == 'Partial'*/1==0))
									{
			...
			case 'stagetaken':
								...
								{
									setObjectCamera('foxyjump', 'camHUD');
								}
								addLuaSprite('foxyjump', false);
								...
								for (miscSprite in miscSprites)
								{
									...
									setScrollFactor(miscSprite.name, miscSprite.scrollX, miscSprite.scrollY);
									scaleObject(miscSprite.name, miscSprite.scaleX, miscSprite.scaleX);
									if ((miscSprite.camera != 'camGame' && 1 == 0/*immersionLevel == 'Partial'*/))
									{
										setObjectCamera(miscSprite.name, 'camEasy');
									}
									else
									...
									addLuaSprite(miscSprite.name, false);
									setProperty(miscSprite.name + '.alpha', miscSprite.alpha);
								}
		...
		switch (curStep)
		{
			...
			case 'stagepp':
							...
							if (curStep == 720)
							{
								...
								dadChars.get('paperbonnie').alpha = 1;
							}
							if (curStep == 1392)
							{
							...
							if (curStep == 1936)
							{
								...
								addLuaSprite('paperpeople2', false);
			...
			case 'stageverlasting':
							...
							else if (curStep == 1678)
							{
								...
								triggerEventNote('Videoplayer', 'everlasting', '');
							}
							else if (curStep == 2736)
							{
							...
							else if (curStep == 2758)
							{
								...
								setProperty('UpperBar.visible', true);
								setProperty('LowerBar.visible', true);
							...
							else if (curStep == 3280)
							{
								...
								triggerEventNote('Videoplayer', 'leftbehind', '');
								setObjectOrder('leftbehind', 0);
								setObjectOrder('dadGroup', 1);
								setObjectOrder('boyfriendGroup', 2);
							}
							else if (curStep == 3792)
							{
			...
			case 'stagephantom':
							...
							else if (curStep == 640)
							{
								...
								doTweenAlpha('phfreddyjumpinverted', 'phfreddyjumpinverted', 0, 1);
							...
							else if (curStep == 3360)
							{
								setProperty('black.alpha', 1);
							}
							else if (curStep == 3376)
							{
								setProperty('black.alpha', 1);
								doTweenAlpha('blackTransition', 'black', 0, 1, 'linear');
							...
							else if (curStep == 3388)
							{
								doTweenAlpha('blackTransition', 'black', 0, 6, 'linear');
							}
							else if (curStep == 4404)
							{
								doTweenAlpha('blackTransition', 'black', 0, 1, 'linear');
			...
			case 'stageretribution':
							...
							else if (curStep == 1952)
							{
								...
								setScrollFactor('boyfriendGroup', 1, 1.5);
								setObjectOrder('dadGroup', 7);
								setObjectOrder('children', 8);
								setObjectOrder('boyfriendGroup', 9);
							}
							else if (curStep == 2208)
							{
	...
	override function beatHit()
	{
		...
		switch (curStage)
		{
			case 'stagephantom':
							...
							else if (curBeat == 1072)
							{
								doTweenAlpha('strumFadeOut', 'camHUD', 0, 0.25, 'linear');
							}
							else if (curBeat == 1100)
							{
								doTweenAlpha('strumFadeIn', 'camHUD', 1, 1, 'linear');
							}
							else if (curBeat == 1236)
							{
								doTweenAlpha('strumFadeOut', 'camHUD', 0, 0.25, 'linear');
							}
							else if (curBeat == 1264)
							{
								doTweenAlpha('strumFadeIn', 'camHUD', 1, 3, 'linear');
							}
			
			case 'stageretribution':
							if (curBeat >= 552 && curBeat % 3 == 0)
							{
